...
from decorators import beanstalk_job  # NOQA
...
class BeanstalkClient(object):
    ...
    def call(self, func, arg='', priority=DEFAULT_PRIORITY, delay=0,
             ttr=DEFAULT_TTR):
        """
        ...
        ttr: how many seconds a worker has to process the job before it gets
             requeued
        """
